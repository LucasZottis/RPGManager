...
public class Dictionaries
{
    ...
    public RaceRuleCollection Races { get; private set; } = new();
    public ClassRuleCollection Classes { get; private set; } = new();
    public BackgroundRuleCollection Backgrounds { get; private set; } = new();
}
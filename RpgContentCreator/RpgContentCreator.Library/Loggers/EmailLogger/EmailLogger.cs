...
public class EmailLogger<TCategory> : ILogger<TCategory>
{
    ...
    public EmailLogger( string smtpServer, string smtpUsername, string smtpPassword, string toEmail, string fromEmail )
    {
    ...
    public void Log<TState>( LogLevel logLevel, EventId eventId, TState state, Exception? exception, Func<TState, Exception?, string> formatter )
    {
        ...
        var logEntry = new LogEntry
        {
            ...
            Category = typeof( TCategory ).FullName // Captura o nome da categoria+,
        };
